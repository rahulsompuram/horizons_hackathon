...
class PublicKeys(base.Group):
  ...
  key" is composed of a "main" key pair and zero or more "subkey" pairs
  certified by the main. These key pairs are collectively known as the "PGP
  ...
  main key pair cannot be revoked by this same mechanism.

  ### COMMON KEY STRUCTURE

  The most common key structure is to have the main key pair only used to
